...
type Builder interface {
	...
	WithMargins(left float64, top float64, right float64, bottom float64) Builder
...
func (b *CfgBuilder) WithMargins(left float64, top float64, right float64, bottom float64) Builder {
